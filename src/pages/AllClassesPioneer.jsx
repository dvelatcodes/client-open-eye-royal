...
const AllClassesPioneer = () => {
  ...
  // state initialization
  const { isSuccess, isError, isLoading, message, timetable, pioneerClass } =
  ...
  useEffect(() => {
    ...
    if (pioneerClasses) {
      ...
      // console.log(pioneerClass.filter(
      //   (all) =>
      //     all.classNaming.match("JSS 1") ||
      //     all.classNaming.match("JSS 2") ||
      //     all.classNaming.match("JSS 3")
  ...
  useEffect(() => {
    // tests && scienceClass && artClass && classNum &&
    // if(scienceClass || commercialClass){
    // jss 1a
    classNum?.filter((data) => data.classNaming === "JSS 1A") &&
      tests
        ...
        ?.map((all) => {
          ...
          const js1aFinalTue = Math.floor(js1aIniTue * all.courses.length);
          ...
          const js1aFinalWed = Math.floor(js1aIniWed * all.courses.length);
          ...
          const js1aFinalThur = Math.floor(js1aIniThur * all.courses.length);

          if (!js1aThur.includes(all.courses[js1aFinalThur].subName)) {
          ...
          const js1aFinalFri = Math.floor(js1aIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      tests
        ...
        ?.map((all) => {
          ...
          const js1bFinalTue = Math.floor(js1bIniTue * all.courses.length);
          ...
          const js1bFinalWed = Math.floor(js1bIniWed * all.courses.length);
          ...
          const js1bFinalThur = Math.floor(js1bIniThur * all.courses.length);

          if (!js1bThur.includes(all.courses[js1bFinalThur].subName)) {
          ...
          const js1bFinalFri = Math.floor(js1bIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      tests
        ...
        ?.map((all) => {
          ...
          const js1cFinalTue = Math.floor(js1cIniTue * all.courses.length);
          ...
          const js1cFinalWed = Math.floor(js1cIniWed * all.courses.length);
          ...
          const js1cFinalThur = Math.floor(js1cIniThur * all.courses.length);

          if (!js1cThur.includes(all.courses[js1cFinalThur].subName)) {
          ...
          const js1cFinalFri = Math.floor(js1cIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      tests
        ...
        ?.map((all) => {
          ...
          const js1dFinalTue = Math.floor(js1dIniTue * all.courses.length);
          ...
          const js1dFinalWed = Math.floor(js1dIniWed * all.courses.length);
          ...
          const js1dFinalThur = Math.floor(js1dIniThur * all.courses.length);

          if (!js1dThur.includes(all.courses[js1dFinalThur].subName)) {
          ...
          const js1dFinalFri = Math.floor(js1dIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      tests
        ...
        ?.map((all) => {
          ...
          const js2aFinalTue = Math.floor(js2aIniTue * all.courses.length);
          ...
          const js2aFinalWed = Math.floor(js2aIniWed * all.courses.length);
          ...
          const js2aFinalThur = Math.floor(js2aIniThur * all.courses.length);

          if (!js2aThur.includes(all.courses[js2aFinalThur].subName)) {
          ...
          const js2aFinalFri = Math.floor(js2aIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      tests
        ...
        ?.map((all) => {
          ...
          const js2bFinalTue = Math.floor(js2bIniTue * all.courses.length);
          ...
          const js2bFinalWed = Math.floor(js2bIniWed * all.courses.length);
          ...
          const js2bFinalThur = Math.floor(js2bIniThur * all.courses.length);

          if (!js2bThur.includes(all.courses[js2bFinalThur].subName)) {
          ...
          const js2bFinalFri = Math.floor(js2bIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      tests
        ...
        ?.map((all) => {
          ...
          const js2cFinalTue = Math.floor(js2cIniTue * all.courses.length);
          ...
          const js2cFinalWed = Math.floor(js2cIniWed * all.courses.length);
          ...
          const js2cFinalThur = Math.floor(js2cIniThur * all.courses.length);

          if (!js2cThur.includes(all.courses[js2cFinalThur].subName)) {
          ...
          const js2cFinalFri = Math.floor(js2cIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      tests
        ...
        ?.map((all) => {
          ...
          const js2dFinalTue = Math.floor(js2dIniTue * all.courses.length);
          ...
          const js2dFinalWed = Math.floor(js2dIniWed * all.courses.length);
          ...
          const js2dFinalThur = Math.floor(js2dIniThur * all.courses.length);

          if (!js2dThur.includes(all.courses[js2dFinalThur].subName)) {
          ...
          const js2dFinalFri = Math.floor(js2dIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      tests
        ...
        ?.map((all) => {
          ...
          const js3aFinalTue = Math.floor(js3aIniTue * all.courses.length);
          ...
          const js3aFinalWed = Math.floor(js3aIniWed * all.courses.length);
          ...
          const js3aFinalThur = Math.floor(js3aIniThur * all.courses.length);

          if (!js3aThur.includes(all.courses[js3aFinalThur].subName)) {
          ...
          const js3aFinalFri = Math.floor(js3aIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      tests
        ...
        ?.map((all) => {
          ...
          const js3bFinalTue = Math.floor(js3bIniTue * all.courses.length);
          ...
          const js3bFinalWed = Math.floor(js3bIniWed * all.courses.length);
          ...
          const js3bFinalThur = Math.floor(js3bIniThur * all.courses.length);

          if (!js3bThur.includes(all.courses[js3bFinalThur].subName)) {
          ...
          const js3bFinalFri = Math.floor(js3bIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      tests
        ...
        ?.map((all) => {
          ...
          const js3cFinalTue = Math.floor(js3cIniTue * all.courses.length);
          ...
          const js3cFinalWed = Math.floor(js3cIniWed * all.courses.length);
          ...
          const js3cFinalThur = Math.floor(js3cIniThur * all.courses.length);

          if (!js3cThur.includes(all.courses[js3cFinalThur].subName)) {
          ...
          const js3cFinalFri = Math.floor(js3cIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      tests
        ...
        ?.map((all) => {
          ...
          const js3dFinalTue = Math.floor(js3dIniTue * all.courses.length);
          ...
          const js3dFinalWed = Math.floor(js3dIniWed * all.courses.length);
          ...
          const js3dFinalThur = Math.floor(js3dIniThur * all.courses.length);

          if (!js3dThur.includes(all.courses[js3dFinalThur].subName)) {
          ...
          const js3dFinalFri = Math.floor(js3dIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      classNum
        ...
        ?.map((all) => {
          ...
          const ss1aFinalTue = Math.floor(ss1aIniTue * all.courses.length);
          ...
          const ss1aFinalWed = Math.floor(ss1aIniWed * all.courses.length);
          ...
          const ss1aFinalThur = Math.floor(ss1aIniThur * all.courses.length);

          if (!ss1aThur.includes(all.courses[ss1aFinalThur].subName)) {
          ...
          const ss1aFinalFri = Math.floor(ss1aIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      classNum
        ...
        ?.map((all) => {
          ...
          const ss1bFinalTue = Math.floor(ss1bIniTue * all.courses.length);
          ...
          const ss1bFinalWed = Math.floor(ss1bIniWed * all.courses.length);
          ...
          const ss1bFinalThur = Math.floor(ss1bIniThur * all.courses.length);

          if (!ss1bThur.includes(all.courses[ss1bFinalThur].subName)) {
          ...
          const ss1bFinalFri = Math.floor(ss1bIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      artClass
        ...
        ?.map((all) => {
          ...
          const ss1cFinalTue = Math.floor(ss1cIniTue * all.courses.length);
          ...
          const ss1cFinalWed = Math.floor(ss1cIniWed * all.courses.length);
          ...
          const ss1cFinalThur = Math.floor(ss1cIniThur * all.courses.length);

          if (!ss1cThur.includes(all.courses[ss1cFinalThur].subName)) {
          ...
          const ss1cFinalFri = Math.floor(ss1cIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      commercialClass
        ...
        ?.map((all) => {
          ...
          const ss1dFinalTue = Math.floor(ss1dIniTue * all.courses.length);
          ...
          const ss1dFinalWed = Math.floor(ss1dIniWed * all.courses.length);
          ...
          const ss1dFinalThur = Math.floor(ss1dIniThur * all.courses.length);

          if (!ss1dThur.includes(all.courses[ss1dFinalThur].subName)) {
          ...
          const ss1dFinalFri = Math.floor(ss1dIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      classNum
        ...
        ?.map((all) => {
          ...
          const ss2aFinalTue = Math.floor(ss2aIniTue * all.courses.length);
          ...
          const ss2aFinalWed = Math.floor(ss2aIniWed * all.courses.length);
          ...
          const ss2aFinalThur = Math.floor(ss2aIniThur * all.courses.length);

          if (!ss2aThur.includes(all.courses[ss2aFinalThur].subName)) {
          ...
          const ss2aFinalFri = Math.floor(ss2aIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      classNum
        ...
        ?.map((all) => {
          ...
          const ss2bFinalTue = Math.floor(ss2bIniTue * all.courses.length);
          ...
          const ss2bFinalWed = Math.floor(ss2bIniWed * all.courses.length);
          ...
          const ss2bFinalThur = Math.floor(ss2bIniThur * all.courses.length);

          if (!ss2bThur.includes(all.courses[ss2bFinalThur].subName)) {
          ...
          const ss2bFinalFri = Math.floor(ss2bIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      artClass
        ...
        ?.map((all) => {
          ...
          const ss2cFinalTue = Math.floor(ss2cIniTue * all.courses.length);
          ...
          const ss2cFinalWed = Math.floor(ss2cIniWed * all.courses.length);
          ...
          const ss2cFinalThur = Math.floor(ss2cIniThur * all.courses.length);

          if (!ss2cThur.includes(all.courses[ss2cFinalThur].subName)) {
          ...
          const ss2cFinalFri = Math.floor(ss2cIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      commercialClass
        ...
        ?.map((all) => {
          ...
          const ss2dFinalTue = Math.floor(ss2dIniTue * all.courses.length);
          ...
          const ss2dFinalWed = Math.floor(ss2dIniWed * all.courses.length);
          ...
          const ss2dFinalThur = Math.floor(ss2dIniThur * all.courses.length);

          if (!ss2dThur.includes(all.courses[ss2dFinalThur].subName)) {
          ...
          const ss2dFinalFri = Math.floor(ss2dIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      classNum
        ...
        ?.map((all) => {
          ...
          const ss3aFinalTue = Math.floor(ss3aIniTue * all.courses.length);
          ...
          const ss3aFinalWed = Math.floor(ss3aIniWed * all.courses.length);
          ...
          const ss3aFinalThur = Math.floor(ss3aIniThur * all.courses.length);

          if (!ss3aThur.includes(all.courses[ss3aFinalThur].subName)) {
          ...
          const ss3aFinalFri = Math.floor(ss3aIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      classNum
        ...
        ?.map((all) => {
          ...
          const ss3bFinalTue = Math.floor(ss3bIniTue * all.courses.length);
          ...
          const ss3bFinalWed = Math.floor(ss3bIniWed * all.courses.length);
          ...
          const ss3bFinalThur = Math.floor(ss3bIniThur * all.courses.length);

          if (!ss3bThur.includes(all.courses[ss3bFinalThur].subName)) {
          ...
          const ss3bFinalFri = Math.floor(ss3bIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      artClass
        ...
        ?.map((all) => {
          ...
          const ss3cFinalTue = Math.floor(ss3cIniTue * all.courses.length);
          ...
          const ss3cFinalWed = Math.floor(ss3cIniWed * all.courses.length);
          ...
          const ss3cFinalThur = Math.floor(ss3cIniThur * all.courses.length);

          if (!ss3cThur.includes(all.courses[ss3cFinalThur].subName)) {
          ...
          const ss3cFinalFri = Math.floor(ss3cIniFri * all.courses.length);
    ...
    classNum?.some((arr) => {
      ...
      commercialClass
        ...
        ?.map((all) => {
          ...
          const ss3dFinalTue = Math.floor(ss3dIniTue * all.courses.length);
          ...
          const ss3dFinalWed = Math.floor(ss3dIniWed * all.courses.length);
          ...
          const ss3dFinalThur = Math.floor(ss3dIniThur * all.courses.length);

          if (!ss3dThur.includes(all.courses[ss3dFinalThur].subName)) {
          ...
          const ss3dFinalFri = Math.floor(ss3dIniFri * all.courses.length);
